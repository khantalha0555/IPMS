...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 12, 2020 at 09:37 AM
...
-- Database: `ipms`
--
CREATE DATABASE IF NOT EXISTS `ipms` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `ipms`;
...
(17, 'Talha', 'ktalha548@yahoo.com', 9819180555, 'G/101 wafa complex, sharifa road amrut n', 'FEMALE', 123456, 'khan', 23, 10);
...
('root', '[{\"db\":\"ipms\",\"table\":\"signup\"},{\"db\":\"ipms\",\"table\":\"loginform\"},{\"db\":\"ipms\",\"table\":\"setrange\"}]');
...
('root', 'ipms', 'signup', '{\"CREATE_TIME\":\"2019-12-28 14:47:04\",\"sorted_col\":\"`signup`.`patient`  ASC\"}', '2020-01-06 19:50:35');
...
('root', '2020-01-12 08:36:41', '{\"Console\\/Mode\":\"collapse\"}');
